# JobStager — design notes

The original pitch, market analysis, architecture and roadmap. Moved out of the README, which is now written for people using JobStager.
